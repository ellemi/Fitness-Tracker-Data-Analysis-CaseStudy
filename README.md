...
<img width="945" alt="Bellabeat Tableau Project" src="https://github.com/ellemi/Fitness-App-Data-Analysis/assets/28688643/282ea024-b28b-427a-bb88-d7fbb5445347">


[This Tableau project](https://public.tableau.com/views/BellabeatCaseStudy_16883416240690/Intro?:language=en-US&:display_count=n&:origin=viz_share_link) shows breakdowns and data summaries in visual form.


 
## Act
A future analysis of data, generated by women, that are more recent and consistant will provide a more complete understanding of trends in fitness trackers. 
...
- Women interested in achieving greater levels of daily activity leading to with a goal of improved health.

- Women who want to improve their sleep habits for greater self-care and a more active life. 

- Women looking for a fitness tracker with more versatile wearbility than many of the popular ones that are limited to wrist wear. 

In all segments, encouraging users to wear the device 24/7 because of its fashionable design and versatility will help to foster a sense of partnership with Bellabeat. 
